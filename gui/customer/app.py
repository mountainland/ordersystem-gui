...
class CustomerApp(customtkinter.CTkToplevel):
    ...
    def build_menu(self):
        ...
        self.fetch_button = customtkinter.CTkButton(self, text="Get Customer Info", command=self.fetch_customer_info)
    ...
    def fetch_customer_info(self):
        ...
        try:
            ...
            close_button = customtkinter.CTkButton(popup_window, text="Close", command=lambda: self.shut(popup_window))
